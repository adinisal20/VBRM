...
class ImageSubscriber : public rclcpp::Node
{
  ...
  private:
	...
	{    
		...
		RCLCPP_INFO(this->get_logger(), "Coordinates of center of blue circle:(%d, %d)",blue_center.x,blue_center.y);
		RCLCPP_INFO(this->get_logger(), "Coordinates of center of red circle:(%d, %d)",red_center.x,red_center.y);
		RCLCPP_INFO(this->get_logger(), "Coordinates of center of green circle:(%d, %d)",green_center.x,green_center.y);
		RCLCPP_INFO(this->get_logger(), "Coordinates of center of magenta circle:(%d, %d)",magenta_center.x,magenta_center.y);
